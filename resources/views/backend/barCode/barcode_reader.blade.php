...
<div class="page-content">
  ...
  <div class="card">
    <div class="card-body">
      <button id="startScanButton" onclick="startScan()" class="btn btn-primary btn-rounded waves-effect
    waves-light">Iniciar Scan</button>
      <button id="stopScanButton" onclick="stopScan()" class="btn btn-danger btn-rounded waves-effect waves-light">Parar
        Scan</button>
      <div id="camera">
  ...
  function startScan() {
    if (!scanning) {
      ...
      Quagga.onDetected(function (result) {
        ...
        if (code.length === 14) { // Verifica se o código possui 14 dígitos
          document.querySelector('#resultado').innerHTML = 'Código de Barras ITF: ' + code;
          Quagga.stop();
          scanning = false;
