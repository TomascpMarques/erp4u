                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> {{ $item->location }} </td>
                                    <td>
                                        <a href="{{ route('postalCodes.edit', $item->id) }}" class="btn btn-info sm"
                                            title="Edit Data"> <i class="fas fa-edit"></i> </a>
                                        <a href="{{ route('postalCodes.delete', $item->id) }}" class="btn btn-danger sm"
