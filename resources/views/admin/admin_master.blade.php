...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Dashboard | ERP4U - Admin & Dashboard Template</title>
    ...
    <body data-topbar="dark">
        ...
        <script src="{{
                asset('backend/assets/libs/metismenu/metisMenu.min.js')
            }}"></script>
        <script src="{{
                asset('backend/assets/libs/simplebar/simplebar.min.js')
            }}"></script>
        <script src="{{
                asset('backend/assets/libs/node-waves/waves.min.js')
            }}"></script>
